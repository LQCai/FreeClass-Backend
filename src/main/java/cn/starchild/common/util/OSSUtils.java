...
public class OSSUtils {
    ...
    static {
        ...
        ACCESS_KEY_ID = "LTAIbY915jkkqQQf";
        ACCESS_KEY_SECRET = "8TzRhlHVa45UQlwmfggtfKk5LZxMbI";
        BACKET_NAME = "free-class";
        FOLDER = "homework-annex/";
    }
    ...
    public static void main(String[] args) {
        ...
        String filename = "C:\\Users\\LQCai\\Pictures\\Camera Roll\\1554724294281.jpg";
        //System.out.println("filename:"+filename);
        File filess = new File(filename);

        OSSUtils ossUtils = new OSSUtils();

        String md5key = ossUtils.uploadObject2OSS(filess, BACKET_NAME, FOLDER);
