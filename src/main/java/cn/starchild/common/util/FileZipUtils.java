...
public class FileZipUtils {
    ...
    public FileZipUtils(File target) {
        targetFile = target;
    ...
    public static void main(String[] args) {
        File f = new File("C:/Users/LQCai/freeClass/upload");
        new FileZipUtils(new File( "C:/Users/LQCai/freeClass/",f.getName()+".zip")).zipFiles(f);
    }
